        ...
        <div className="flex items-center">
          <div className="max-w-1/2 w-full min-h-[570px]">
            <img
              ...
              src="/blinder/blinder_1.png"
              alt="blinder image"
            />
          </div>
          <div className="max-w-1/2 w-full min-h-[570px] bg-[#dadada] p-8 flex justify-center flex-col">
            <span className="text-base text-[#767676] font-poppins font-normal capitalize mb-5 block">
              women collections
            </span>
            <h3 className="text-5xl text-[#484848] font-normal capitalize mb-5">
              peaky blinders
            </h3>
            <span className="text-base text-black font-poppins font-normal uppercase underline mb-5 block">
              description
            </span>
            ...
            <p className="text-base text-[#767676] font-poppins font-normal capitalize">
              size:{" "}
              <span className="inline-block px-4 py-1 bg-black rounded-sm text-white ml-3 mb-5">
                m
              </span>
            </p>
            ...
            <Link
              ...
              className="text-base text-white font-poppins font-medium capitalize px-6 py-2.5 bg-black rounded-lg max-w-[207px] w-full h-auto flex items-center justify-center"
            >
              buy now
            </Link>
          </div>
        ...
        <div className="lg:container mx-auto">
          ...
          <div className="flex items-center justify-between gap-8">
            <div className="flex items-center gap-3">
              <button>
                <FaHandHoldingHeart size={"2.5rem"} color="black" />
              </button>
              <div>
            ...
            <div className="flex items-center gap-3">
              <button>
                <FaAward size={"2.5rem"} color="black" />
              </button>
              <div>
                <h4 className="text-xl text-[#484848] font-poppins font-medium capitalize mb-2">
                  warranty
            ...
            <div className="flex items-center gap-3">
              <button>
                <FaShippingFast size={"2.5rem"} color="black" />
              </button>
              <div>
                <h4 className="text-xl text-[#484848] font-poppins font-medium capitalize mb-2">
                  free shipping
            ...
            <div className="flex items-center gap-3">
              <button>
                <IoCall size={"2.5rem"} color="black" />
              </button>
              <div>
                <h4 className="text-xl text-[#484848] font-poppins font-medium capitalize mb-2">
                  24/7 support
